...
function tattoo_shop_manager_suppliers_post_type()
{
    $labels = array(
        ...
        'new_item' => __('New Supplier', 'tattoo-shop-manager'),
        'edit_item' => __('Edit Supplier', 'tattoo-shop-manager'),
        'update_item' => __('Update Supplier', 'tattoo-shop-manager'),
        'view_item' => __('View Supplier', 'tattoo-shop-manager'),
        'view_items' => __('View Suppliers', 'tattoo-shop-manager'),
        'search_items' => __('Search Suppliers', 'tattoo-shop-manager'),
        ...
        'filter_items_list' => __('Filter Suppliers list', 'tattoo-shop-manager'),
    );
