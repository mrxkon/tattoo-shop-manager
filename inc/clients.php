...
function tattoo_shop_manager_clients_post_type()
{
    $labels = array(
        ...
        'parent_item_colon' => __('Parent Client:', 'tattoo-shop-manager'),
        'all_items' => __('All Clients', 'tattoo-shop-manager'),
        'add_new_item' => __('Add New Client', 'tattoo-shop-manager'),
        'add_new' => __('Add New Client', 'tattoo-shop-manager'),
        'new_item' => __('New Client', 'tattoo-shop-manager'),
        'edit_item' => __('Edit Client', 'tattoo-shop-manager'),
        'update_item' => __('Update Client', 'tattoo-shop-manager'),
        'view_item' => __('View Client', 'tattoo-shop-manager'),
        'view_items' => __('View Clients', 'tattoo-shop-manager'),
        'search_items' => __('Search Clients', 'tattoo-shop-manager'),
        ...
        'filter_items_list' => __('Filter Clients list', 'tattoo-shop-manager'),
    );
