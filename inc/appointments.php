...
function tattoo_shop_manager_appointments_taxonomy()
{
    $labels = array(
        ...
        'all_items' => __('All', 'tattoo-shop-manager'),
        ...
        'new_item_name' => __('New', 'tattoo-shop-manager'),
        ...
        'add_or_remove_items' => __('Add or remove', 'tattoo-shop-manager'),
        'choose_from_most_used' => __('Choose from the most used', 'tattoo-shop-manager'),
        'popular_items' => __('Popular', 'tattoo-shop-manager'),
        'search_items' => __('Search', 'tattoo-shop-manager'),
        'not_found' => __('Not Found', 'tattoo-shop-manager'),
        'no_terms' => __('No items', 'tattoo-shop-manager'),
        'items_list' => __('Types list', 'tattoo-shop-manager'),
        'items_list_navigation' => __('Types list navigation', 'tattoo-shop-manager'),
    );
