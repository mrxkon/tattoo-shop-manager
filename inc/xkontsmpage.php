                ...
                <div id="tsm_info_box" class="postbox-container">
                    <div class="meta-box-sortables ui-sortable">
                        ...
                        <div id="toexpire" class="postbox">
                            <h2 class="h2red"><span><?php echo __('About To Expire', 'tattoo-shop-manager'); ?></span></h2>
                            <hr/>
                            <div class="inside">
                                <div class="main">
                                    ...
                                    echo '</thead>';
                                    echo '<tbody>';
                                    while ($inkexpires->have_posts()) : $inkexpires->the_post();
                                        echo '<tr><td><a href="post.php?post=' . get_the_ID() . '&action=edit">';
                                        echo the_title();
                                        echo '</a></td>';
                                        echo '<td>';
                                    ...
                                    echo '</thead>';
                                    echo '<tbody>';
                                    while ($needleexpires->have_posts()) : $needleexpires->the_post();
                                        echo '<tr><td><a href="post.php?post=' . get_the_ID() . '&action=edit">';
                                        echo the_title();
                                        echo '</a></td>';
                                        echo '<td>';
