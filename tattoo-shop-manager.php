...
function tattoo_shop_manager_admin_menu()
{
    ...
    add_submenu_page(
        ...
        'Appointments',
        'manage_options',
        'edit.php?post_type=tsm-appointments',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-appointments',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Appointment Types',
        'manage_options',
        'edit-tags.php?taxonomy=tsm-appointments-taxonomy&post_type=tsm-appointments',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Employees',
        'manage_options',
        'edit.php?post_type=tsm-employees',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-employees',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Job Positions',
        'manage_options',
        'edit-tags.php?taxonomy=tsm-employees-taxonomy&post_type=tsm-employees',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Clients',
        'manage_options',
        'edit.php?post_type=tsm-clients',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-clients',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-inks',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Ink Companies & Sets',
        'manage_options',
        'edit-tags.php?taxonomy=tsm-inks-taxonomy&post_type=tsm-inks',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Needles',
        'manage_options',
        'edit.php?post_type=tsm-needles',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-needles',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Needle Companies',
        'manage_options',
        'edit-tags.php?taxonomy=tsm-needles-taxonomy&post_type=tsm-needles',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Suppliers',
        'manage_options',
        'edit.php?post_type=tsm-suppliers',
        ''
    );
    ...
    add_submenu_page(
        ...
        'Add New',
        'manage_options',
        'post-new.php?post_type=tsm-suppliers',
        ''
    );
